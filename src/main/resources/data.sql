...
('Lettuce'), ('Cucumber'), ('Bell Pepper'), ('Green Chili'), ('Red Chili'),
('Eggplant'), ('Zucchini'), ('Pumpkin'), ('Sweet Potato'), ('Beetroot'),
('Radish'), ('Green Beans'), ('Peas'), ('Corn'), ('Mushroom'),
('Celery'), ('Asparagus'), ('Leek'), ('Spring Onion'), ('Okra'),
('Bitter Gourd'), ('Bottle Gourd'), ('Ridge Gourd'), ('Drumstick'), ('Curry Leaves'),
('Coriander Leaves'), ('Mint Leaves'), ('Fenugreek Leaves'), ('Red Cabbage'), ('Kale'),
...
('Strawberry'), ('Blueberry'), ('Pomegranate'), ('Guava'), ('Pear'),
...
('Cinnamon'), ('Cloves'), ('Bay Leaf'), ('Nutmeg'), ('Star Anise'),
('Fenugreek Seeds'), ('Asafoetida'), ('Paprika'), ('Oregano'), ('Basil'),
('Thyme'), ('Rosemary'), ('Parsley'), ('Chili Flakes'), ('Curry Powder'),
...
('Prawns'), ('Tofu'), ('Chickpeas'), ('Kidney Beans'), ('Black Beans'),
...
('Cornstarch'), ('Gelatin'), ('Icing Sugar'), ('Almond Flour'), ('Milk Powder');
